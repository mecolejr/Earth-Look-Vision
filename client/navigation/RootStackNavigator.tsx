...
// Feature 3: Import ScenarioTestingScreen
import ScenarioTestingScreen from "@/screens/ScenarioTestingScreen";
...
export type RootStackParamList = {
      ...
      // Feature 3: Add ScenarioTesting to the root stack
      ScenarioTesting: undefined;
};
                          ...
                          <>
                              ...
                              {/* Issue #10 fix: Expose interactive demo after onboarding */}
                                    <Stack.Screen
                                                  ...
                                                  />
                              {/* Feature 3: Scenario testing screen */}
                                    <Stack.Screen
                                                    name="ScenarioTesting"
                                                    component={ScenarioTestingScreen}
                                                    options={{
                                                                      presentation: "modal",
                                                                      headerTitle: "What If? Scenario Testing",
                                                    }}
                                                  />
                          </>>
                        ) : (
