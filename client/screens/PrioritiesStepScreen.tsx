...
function computeSmartDefaults(
  ...
  // LGBTQ+ orientation or non-binary gender → boost LGBTQ acceptance & safety
  ...
  // Ethnic minority → boost diversity & safety
  ...
  // Income signals → adjust cost of living weight
  ...
  // Family with children → boost safety & cost of living
...
export default function PrioritiesStepScreen({
  ...
  useEffect(() => {
    ...
    if (!allDefault) return; // user already has custom priorities — don't overwrite
