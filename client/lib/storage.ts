...
/**
 * Issue #14 / #21: Stable JSON serialization with proper types instead of `any`.
 * Guarantees consistent key ordering across JS engines.
 */
...
/**
 * Issue #21 fix: Replace `any` params with proper types.
 */
...
/**
 * Issue #21 fix: Typed parameters instead of `any`.
 */
export async function setCachedCityScores(
    ...
    try {
          ...
          await AsyncStorage.setItem(
                  STORAGE_KEYS.CITY_SCORES_CACHE,
...
const DEFAULT_CHECKLIST_ITEMS: Omit<ChecklistItem, "id">[] = [
  {
        text: "Research neighborhoods and housing options",
        completed: false,
        category: "before",
  },
  {
        text: "Calculate cost of living differences",
        completed: false,
        category: "before",
  },
  {
        text: "Find LGBTQ+ friendly healthcare providers",
        completed: false,
        category: "before",
  },
  {
        text: "Research local community groups and organizations",
        completed: false,
        category: "before",
  },
  {
        text: "Visit the city if possible",
        completed: false,
        category: "before",
  },
  {
        text: "Start job search or remote work transition",
        completed: false,
        category: "before",
  },
  {
        text: "Get quotes from moving companies",
        completed: false,
        category: "before",
  },
  {
        text: "Notify current landlord/prepare current home",
        completed: false,
        category: "before",
  },
  {
        text: "Transfer utilities and update address",
        completed: false,
        category: "during",
  },
  {
  ...
  {
        text: "Update driver's license and vehicle registration",
        completed: false,
        category: "during",
  },
  {
        text: "Register to vote at new address",
        completed: false,
        category: "during",
  },
  {
        text: "Find local grocery stores and pharmacies",
        completed: false,
        category: "after",
  },
  {
        text: "Locate nearest emergency services",
        completed: false,
        category: "after",
  },
  {
        text: "Connect with local community groups",
        completed: false,
        category: "after",
  },
  {
        text: "Explore the neighborhood and meet neighbors",
        completed: false,
        category: "after",
  },
  {
  ...
  {
        text: "Find local services (dentist, mechanic, etc.)",
        completed: false,
        category: "after",
  },
  ];

export async function getMovingChecklist(
    cityId: string
  ): Promise<MovingChecklist | null> {
    try {
          const data = await AsyncStorage.getItem(STORAGE_KEYS.MOVING_CHECKLISTS);
          const checklists: Record<string, MovingChecklist> = data
            ? JSON.parse(data)
                  : {};
...
export async function createMovingChecklist(
    cityId: string
...
export async function saveMovingChecklist(
    ...
    try {
          ...
          await AsyncStorage.setItem(
                  STORAGE_KEYS.MOVING_CHECKLISTS,
